...
import com.example.visa_project.application.VisaApplication;

/**
 * Class that handles image requests using Volley.
 * This class downloads the image using the image URL from the Internet.
 */
public class ImageRequester {
    ...
    private ImageRequester() {
        context = VisaApplication.getAppContext();
