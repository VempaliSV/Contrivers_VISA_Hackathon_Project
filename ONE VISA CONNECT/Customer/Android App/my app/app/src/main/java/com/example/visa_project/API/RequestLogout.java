...
import static com.example.visa_project.HomeActivity.llProgressBar;
...
public class RequestLogout extends AsyncTask<String, Void, String> {
    ...
    protected void onPostExecute(String flag) {
        ...
        Activity logout = (Activity)context;
        llProgressBar.setVisibility(View.GONE);
        logout.getWindow().clearFlags(WindowManager.LayoutParams.FLAG_NOT_TOUCHABLE);
